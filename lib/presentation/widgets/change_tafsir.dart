...
class ChangeTafsir extends StatelessWidget {
      ...
      builder: (tafsirCtrl) => PopupMenuButton(
        ...
        itemBuilder: (context) => List.generate(tafsirName.length, (index) {
          return PopupMenuItem(
            ...
            child: Column(
              children: [
                _tafsirBuild(context, index, tafsirCtrl),
                index == 4
                    ? Padding(
  ...
  Widget _tafsirBuild(BuildContext context, int index, TafsirCtrl tafsirCtrl) {
    bool isDownloaded =
        tafsirCtrl.tafsirDownloadName.contains(tafsirName[index]['name']);
    return ListTile(
      title: Text(
      ...
      trailing: isDownloaded
          ? Container(
              ...
              decoration: BoxDecoration(
                ...
                border: Border.all(color: const Color(0xffCDAD80), width: 2),
                color: Colors.white,
              ),
              ...
              children: [
                Obx(
                  () => SquarePercentIndicator(
                    ...
                    progressColor: index == tafsirCtrl.downloadIndex.value
                        ? tafsirCtrl.onDownloading.value
                            ? Get.theme.indicatorColor
                            : Colors.transparent
                        : Colors.transparent,
                    progress: tafsirCtrl.progress.value,
                  ),
                ),
                IconButton(
