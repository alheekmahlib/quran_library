...
part 'core/extensions/download_estension.dart';
...
part 'data/models/tafsir/tafsir_and_translate_names.dart';
part 'data/models/tafsir/tafsir_name_model.dart';
...
part 'presentation/controllers/surah/surah_ctrl.dart';
part 'presentation/controllers/tafsir/tafsir_ctrl.dart';
part 'presentation/controllers/tafsir/tafsir_ui.dart';
part 'presentation/pages/quran_library_screen.dart';
part 'presentation/pages/surah_display_screen.dart';
...
part 'presentation/widgets/change_tafsir.dart';
...
part 'presentation/widgets/show_tafseer.dart';
