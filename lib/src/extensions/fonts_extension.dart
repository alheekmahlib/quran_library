...
extension FontsExtension on QuranCtrl {
  ...
  Future<void> downloadAllFontsZipFile() async {
    if (GetStorage().read(Preferences().isDownloadedCodeV2Fonts) ??
      ...
      response.stream.listen(
        ...
        onDone: () async {
          ...
          try {
            ...
            GetStorage().write(Preferences().isDownloadedCodeV2Fonts, true);
  ...
  Future<void> deleteFonts() async {
    try {
      ...
      if (await fontsDir.exists()) {
        ...
        GetStorage().write(Preferences().isDownloadedCodeV2Fonts, false);
