...
class BookmarksController extends GetxController {
  ...
  /// any other methods of [BookmarksController].
  void initBookmarks(
  ...
  ///
  /// Calls [QuranController.update] after saving the bookmark.
  void saveBookmark({
    ...
    _quranRepository.saveBookmarks(_flattenBookmarks());
    QuranController.instance.update();
  }
  ...
  ///
  /// Calls [QuranController.update] after removing the bookmark.
  ...
  bool hasBookmark(int surahNum, int ayahUQNum, List? bookmarkList) =>
      (bookmarkList != null && bookmarkList.firstWhereOrNull(((element) =>
