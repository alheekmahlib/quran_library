...
abstract interface class LiveCapableRecitationEngine
  ...
  /// يُستدعى بعد استئناف البثّ إثر إيقاف مؤقت (شيت تصحيح كلمة) — يتيح
  /// للمحرّك إعادة تسليح طور الالتقاط في متتبّع النطاق: الكلام
  /// الانتقالي بعد الإغلاق (إعادة الكلمة المصحَّحة/المواصلة/الانتقال)
  /// لا يُقاس على موضع المؤشر المنزلق أثناء الانتظار، بل يُرسّى من
  /// جديد على موضع المستخدم الفعلي. افتراضيًا لا شيء.
  void onLiveResumed() {}
